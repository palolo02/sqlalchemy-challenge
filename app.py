...
# Versión 1.0.2 May-03-2020
# Versión 1.0.3 May-04-2020
# Versión 1.0.4 May-05-2020
# Versión 1.0.5 May-06-2020
# Versión 1.0.6 May-07-2020
    ...
    return '''
        <html>
            ...
            <body>
                ...
                <h3><a href="./api/v1.0/2017-01-01">/api/v1.0/2017-01-01</a></h3>
                <h3><a href="./api/v1.0/2017-01-01/2017-12-31">/api/v1.0/2017-01-01/2017-12-31</a></h3>
            </body>
        </html>
        '''
...
def precipitation():
    try:
        ...
        return jsonify({"content":precipitation.to_json()})
    except:
...
def stations():
    try:
        ...
        return jsonify({"content":active_stations_df.to_json()})
    except:
        return jsonify({"error":" There is an error with the query. Try agan later"}), 404
...
def temperature():
    try:
        ...
        # See sample data
        return jsonify({"content":waihee_df.to_json()})
    except:
        return jsonify({"error":" There is an error with the query. Try agan later"}), 404
...
def start_temperature(start):
    try:
        ...
        # See sample data
        return jsonify({"content":temp_df.to_json()})
    except:
        return jsonify({"error":" There is an error with the query. Try agan later"}), 404
